...
public class XmlDataBinderProtocolImplementor implements DataBinderProtocolInterface
{
		...
		String encoding) throws IOException
	{
		...
		byte[] xmlResponseBytes = null;
		if ( DataUtils.getBoolean(data, "IS_XML_REQUEST", false))
		{
		    xmlResponseBytes = XmlSerializer.sendResponseBytes(data, cxt, encoding);
		}
		return xmlResponseBytes;
	}
		...
		throws IOException
	{
		...
		{
		    xmlResponse = XmlSerializer.sendResponse(data, cxt);
		}
		return xmlResponse;
	}
