...
$(document).ready(function() {
    ...
    $(".addthis_toolbox").append('<script type="text/javascript" src="/cs/HaysGeneralComponent/assets/js/addthis_widget.js"><\/script>');
    ...
    var lsb = $(".row #pl_left_side");
    var mrb = $(".row .mainVar");
    if (lsb.html() != undefined && lsb.html().indexOf("div") == -1) {
        lsb.width(0);
        mrb.removeClass("col-6").addClass("col-9").css("margin-left", "0");
        $(".mainVar p img").css("max-width", "100%")
    }
});
...
$("#hero-area-image").height(height);
$("#hero-area").height(height);
$("#hero-area-content").height(height)