...
(function(d, l, n) {
    d.anythingSlider = function(m, p) {
        ...
        a.init = function() {
            ...
            if (b.expand) {
                if (!0 === b.aspectRatio) b.aspectRatio = a.$el.width() / a.$el.height();
        ...
        a.updateSlider = function() {
            ...
            a.$items.find("a").unbind("focus.AnythingSlider").bind("focus.AnythingSlider", function(c) {
                ...
                a.$window.scrollLeft(0).scrollTop(0); - 1 !== f && (f >= a.currentPage + b.showMultiple || f < a.currentPage) && (a.gotoPage(f), c.preventDefault())
            });
        ...
        a.setDimensions = function() {
            ...
            var c, f, e, h, g = 0,
                ...
                k = 1 < b.showMultiple && "horizontal" === b.mode ? a.width || a.$window.width() / b.showMultiple : a.$window.width(),
                n = 1 < b.showMultiple && "vertical" === b.mode ? a.height / b.showMultiple || a.$window.height() / b.showMultiple : a.$window.height();
            if (b.expand) {
            ...
            a.$items.each(function(l) {
                h = d(this);
                e = h.children();
                b.resizeContents ? (c = a.width, f = a.height, h.css({
                    width: c,
                    height: f
                }), e.length && ("EMBED" === e[0].tagName && e.attr(m), "OBJECT" === e[0].tagName && e.find("embed").attr(m), 1 === e.length && e.css(m))) : ("vertical" === b.mode ? (c = h.css("display", "inline-block").width(), h.css("display", "")) : c = h.width() || a.width, 1 === e.length && c >= k && (c = e.width() >= k ? k : e.width(), e.css("max-width", c)), h.css({
                    width: c,
                    height: ""
                }), f = 1 === e.length ? e.outerHeight(!0) : h.height(), f <= a.outerPad[1] && (f = a.height), h.css("height", f));
                a.panelSize[l] = [c, f, g];
        ...
        a.getDim = function(c) {
            ...
            if (1 < b.showMultiple)
                for (e = 1; e < b.showMultiple; e++) f = c + e, "vertical" === b.mode ? (d = Math.max(d, a.panelSize[f][0]), g += a.panelSize[f][1]) : (d += a.panelSize[f][0], g = Math.max(g, a.panelSize[f][1]));
            return [d, g]
        };
        ...
        a.gotoPage = function(c, f, e, h) {
            ...
            1 >= a.pages || (a.$lastPage = a.$currentPage, "number" !== typeof c && (c = parseInt(c, 10) || b.startPanel, a.setCurrentPage(c)), f && b.isVideoPlaying(a) || (b.stopAtEnd && !b.infiniteSlides && c > a.pages - b.showMultiple && (c = a.pages - b.showMultiple + 1), a.exactPage = c, c > a.pages + 1 - a.adj && (c = b.infiniteSlides || b.stopAtEnd ? a.pages : 1), c < a.adj && (c = b.infiniteSlides || b.stopAtEnd ? 1 : a.pages), b.infiniteSlides || (a.exactPage = c), a.currentPage = c > a.pages ? a.pages : 1 > c ? 1 : a.currentPage, a.$currentPage = a.$items.eq(a.currentPage - a.adj), a.targetPage = 0 === c ? a.pages : c > a.pages ? 1 : c, a.$targetPage = a.$items.eq(a.targetPage - a.adj), h = "undefined" !== typeof h ? h : b.animationTime, 0 <= h && a.$el.trigger("slide_init", a), 0 < h && !0 === b.toggleControls && a.slideControls(!0), b.buildNavigation && a.setNavigation(a.targetPage), !0 !== f && (f = !1), (!f || b.stopAtEnd && c === a.pages) && a.startStop(!1), 0 <= h && a.$el.trigger("slide_begin", a), setTimeout(function(d) {
                ...
                b.resizeContents || (f = a.getDim(c), d = {}, a.$wrapper.width() !== f[0] && (d.width = f[0] || a.width, g = !1), a.$wrapper.height() !== f[1] && (d.height = f[1] || a.height, g = !1), g || a.$wrapper.filter(":not(:animated)").animate(d, {
                    queue: !1,
                    duration: 0 > h ? 0 : h,
                    easing: b.easing
                }));
                ...
                })) : a.endAnimation(c, e, h) : (d = {}, d[a.dir] = -a.panelSize[b.infiniteSlides && 1 < a.pages ? c : c - 1][2], "vertical" !== b.mode || b.resizeContents || (d.width = f[0]), a.$el.filter(":not(:animated)").animate(d, {
                    queue: !1,
                    duration: 0 > h ? 0 : h,
                    easing: b.easing,
                    complete: function() {
        ...
        a.slideControls = function(c) {
            var d = c ? "slideDown" : "slideUp",
                e = c ? 0 : b.animationTime,
                h = c ? b.animationTime : 0,
                g = c ? 1 : 0;
            c = c ? 0 : 1;
            b.toggleControls && a.$controls.stop(!0, !0).delay(e)[d](b.animationTime / 2).delay(h);
            b.buildArrows && b.toggleArrows && (!a.hovered && a.playing && (c = 1, g = 0), a.$forward.stop(!0, !0).delay(e).animate({
                right: a.arrowRight + c * a.arrowWidth,
                opacity: g
            }, b.animationTime / 2), a.$back.stop(!0, !0).delay(e).animate({
                left: a.arrowLeft + c * a.arrowWidth,
                opacity: g
            }, b.animationTime / 2))
        };
...
(function(d) {
    ...
    function p(S, af) {
        ...
        function aa(aM) {
            ...
            aM.preventDefault();
            Y = B();
            if (af.triggerOnTouchEnd || (af.triggerOnTouchEnd == !1 && O === i)) {
                O = g;
...
$(function() {
    ...
    $('ul > li:first-child, ol > li:first-child, dl > dt:first-child, dl > dd:first-child').addClass('first');
    $('ul > li:last-child, ol > li:last-child, dl > dd:last-child, article > p:last-child, div > p:last-child').addClass('last');
    $('.row').each(function() {
        if ($(this).children('.col').length > 1) {
            $(this).children('.col:first-child').addClass('first');
            $(this).children('.col:last-child').addClass('last')
        } else {
            $(this).addClass('single-col')
        }
    });
    $('#toggle-worldwide').click(function(e) {
        $('#toggle-employer-subNav').removeClass('here');
        $('body').removeClass('employer-subNav-active');
        $('#hays-employer-subNav').removeClass('active').slideUp(300);
        $('#mobile-menu-icon').removeClass('active');
        if ($(this).hasClass('here')) {
            $(this).removeClass('here');
            $('#hays-worldwide').removeClass('active').slideUp(300);
            $('body').removeClass('worldwide-active');
            $('.overlay').remove()
        } else {
            $(this).addClass('here').parents('#menu').addClass('worldwide-active');
            $('#hays-worldwide').addClass('active').slideDown(300);
    ...
    $('#toggle-employer-subNav').html(text + '<i class="icon-sort-down"></i>');
    $('#toggle-employer-subNav').click(function(e) {
        $('#toggle-worldwide').removeClass('here');
        $('body').removeClass('worldwide-active');
        $('#hays-worldwide').removeClass('active').slideUp(300);
        $('#mobile-menu-icon').removeClass('active');
        if ($(this).hasClass('here')) {
            ...
            $(this).addClass('here').parents('#menu').addClass('employer-subNav-active');
            $('#hays-employer-subNav').addClass('active').slideDown(300);
            $('body').addClass('employer-subNav-active').append('<div class="overlay"></div>')
        }
        e.preventDefault();
        e.stopPropagation()
    });
    ...
    $('#header-msg .btn-close').click(function(e) {
        $(this).hide().parent('#header-msg').slideUp(300);
        e.preventDefault()
    });
    $('body').on('click', '.btn-on-off', function(e) {
        if ($(this).hasClass('state-on')) {
            $(this).removeClass('state-on').children('span').text('Off')
        } else {
            $(this).addClass('state-on').children('span').text('On')
        }
        e.preventDefault()
    });
    $('body').on('click', '.basic-job-search .adv-opt', function(e) {
        $(this).parents('.basic-job-search').find('.action').hide();
        $(this).parents('.job-search').find('.advanced-job-search').slideDown(300);
        e.preventDefault()
    });
    $('body').on('click', '.advanced-job-search .adv-opt', function(e) {
        $(this).parents('.job-search').find('.basic-job-search .action').show();
        $(this).parents('.advanced-job-search').slideUp(500);
        $('html, body').animate({
            scrollTop: $('.job-search .basic-job-search').offset().top - 140
        }, 'slow');
        e.preventDefault()
    });
    $(".chk-pay-opt input").click(function() {
        if ($(this).is(':checked')) {
            $(this).parents('div').next('.pay-opt').slideDown(300)
        } else {
            $(this).parents('div').next('.pay-opt').slideUp(300)
        }
    });
    ...
    $('.hays-tabs .tabs li:first-child').addClass('active');
    $('.hays-tabs .tab-contents > li:first-child').show();
    var tabIndex = 1;
    $('.hays-tabs .tabs a').click(function(e) {
        $('.hays-tabs .tabs li').removeClass('active');
        $(this).parent('li').addClass('active');
        tabIndex = $(this).parent('li').index() + 1;
        $('.hays-tabs .tab-contents > li').hide();
        $('.hays-tabs .tab-contents > li:nth-child(' + tabIndex + ')').show();
        e.preventDefault()
    });
    if ($('header').length) {
        var stickyHeader = $('header').offset().top + 150
    }
    var lastScrollTop = 0;
    ...
    $(".hero-area-image-bottom a").addClass("btn btn-primary");
    if ($('#slider1,#slider2').length > 0) {
    ...
    $('#browse-exp-btn_job').click(function() {
        $('#browse-exp_job').fadeIn(400);
        return !1
    });
    $('#browse-exp-btn_candidate').click(function() {
        $('#browse-exp_candidate').fadeIn(400);
        return !1
    });
    $('.browse-exp .btn-close').click(function() {
        $('.browse-exp').fadeOut(400);
        return !1
    });
    $('.expandable-in-mobile h3').click(function(e) {
        if ($(this).parents('.expandable-in-mobile').hasClass('active')) {
            $(this).parents('.expandable-in-mobile').removeClass('active')
        } else {
            $(this).parents('.expandable-in-mobile').addClass('active')
        }
    });
    ...
    $('.exp-list > li > a').click(function(e) {
        if ($(this).parent().children('ul').length > 0) {
            if ($(this).hasClass('active')) {
                $(this).removeClass('active').next('ul').slideUp(100)
            } else {
                $('.exp-list a').removeClass('active');
                $('.exp-list ul').hide(50);
    ...
    $('#banner-job-info h2').each(function() {
        if ($(this).children('.switch-search').length > 0) {
            $(this).addClass('has-switch-search')
        }
    });
    $('.show-job-search').click(function(e) {
        $('.show-job-search, #browse-exp-btn_candidate').addClass('active');
        $('.show-candidate-search, #browse-exp-btn_job').removeClass('active');
        $('#banner-candidate-search').hide();
        $('#banner-job-search').show();
        e.preventDefault()
    });
    $('.show-candidate-search').click(function(e) {
        $('.show-candidate-search, #browse-exp-btn_job').addClass('active');
        $('.show-job-search, #browse-exp-btn_candidate').removeClass('active');
        $('#banner-candidate-search').show();
        $('#banner-job-search').hide();
        e.preventDefault()
    });
    if ($('#banner-heading h1').length) {
        if ($('#banner-heading h1 strong').length == 0) {
            $('#banner-heading h1').contents().filter(function() {
                return this.nodeType == 3 && $.trim($(this).text()) != ''
            }).slice(1).wrap('<strong class="hays-cyan" />')
        }
    }
    $(".fancybox").fancybox({
        autoResize: !0,
    ...
    var height = 354 + $("#hero-area-content #banner-heading").height() - 122;
    $("#hero-area-image, #hero-area, #hero-area-content").height(height);
    $('#pl_left_side > div').each(function() {
