    ...
    function e(q) {
        ...
        if (a) {
            r.fn = function(k) {
                ...
                a.apply(d, h.call(c, t)) === true && !k ? b() : x()
            };
            b()
        } else {
            if (r.fn) {
                s === undefined ? x() : r.fn(s === false);
                return true
            } else {
                x()
            }
    ...
    if (DDDEV.multiselects.length > 0 && DDDEV.ucm) {
        $(DDDEV.multiselects).each(function() {
            ...
            $(".multitoggle", this).click(function() {
                ...
                $(this).hasClass("ms_hover") ? $(this).removeClass("ms_hover").next("ol").slideUp(200) : $(this).addClass("ms_hover").next("ol").slideDown(200)
            });
            ...
            $("input", this).click(function() {
                ...
                if ($(this).attr("id") == "alllocasia") {
                    if (this.checked) {
                        $(this).parent().parent("ol").find("li").addClass("inputdisabled").find("input[type=checkbox]").attr("checked", false).attr("disabled", "disabled");
                        $(this).attr("disabled", false).attr("checked", "checked").parents("li").removeClass("inputdisabled")
                    } else {
                        $(this).parent().parent("ol").find("li,ol").removeClass("inputdisabled").find("input[type=checkbox]").attr("disabled", false)
                    }
                }
            })
        });
...
$("#hero-area-image").height(height);$("#hero-area").height(height);$("#hero-area-content").height(height);
